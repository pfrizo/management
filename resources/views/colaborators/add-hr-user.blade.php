        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-4">
                    ...
                    <form action="{{ route('hr.create-colaborator') }}" method="post">
                        ...
                        <div class="mb-3">
                            <div class="d-flex">
                                ...
                                <div>
                                    <a href="{{ route('departments.new-department') }}" class="btn btn-outline-primary mt-4"><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <a href="{{ route('hr-users') }}" class="btn btn-outline-danger me-3">Cancel</a>
